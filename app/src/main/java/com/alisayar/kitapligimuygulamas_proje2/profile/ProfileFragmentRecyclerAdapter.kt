...
class ProfileFragmentRecyclerAdapter: ListAdapter<PostModel, ProfileFragmentRecyclerAdapter.ViewHolder>(com.alisayar.kitapligimuygulamas_proje2.profile.DiffUtilCallback) {
